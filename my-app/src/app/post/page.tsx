    ...
    <div className="flex  h-full flex-col">
      ...
      <div className="place-items-center rounded-t-[4rem] bg-white relative bottom-14 ">
        ...
        <div className="flex items-center justify-center min-h-24">
          <button className="h-fit bg-darkpink text-lg font-semibold text-white rounded-lg py-2 px-20 cursor-pointer">
            지금 당장 참여하기 ({dummyData.currentPerson}/{dummyData.maxPerson})
          </button>
        </div>
      </div>
    </div>
