...
const Write = () => {
  ...
  return (
    <div className="flex flex-col h-full items-center justify-center">
      ...
      <div className="flex flex-col items-center w-[30rem] space-y-4 my-10">
        ...
        <div className="flex justify-between w-full relative">
          ...
          />
          <input type='time' className='placeholder:text-zinc-500 border-[1.5px] border-solid border-pink outline-darkpink rounded-[3px] h-11 w-36 absolute right-[7rem] px-4 py-2.5 font-semibold text-sm text-zinc-500 cursor-pointer'/>
      ...
      <Link href="/post">
        <button className="w-[30rem] h-fit bg-darkpink text-md font-semibold text-white rounded-lg py-2 px-20 cursor-pointer">완료</button>  
      </Link>
    </div>
  );
};
